...
function renderAnalysis(){
 ...
 const sig=JSON.stringify({type:a.type,title:a.title,amount:a.amount,readiness:r.readiness,label:r.label,completeness:r.completeness,urgency:r.urgency,complexity:r.complexity,humanReview:r.humanReview,next:r.next,evidence:e,ladder:lad,source:r.source});
