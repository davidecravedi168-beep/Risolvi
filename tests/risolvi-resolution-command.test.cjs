...
assert.equal(cmd.VERSION,'RISOLVI-RESOLUTION-COMMAND-11.0');
...
let c={id:'c1',title:'Addebito',type:'charge',status:'in_progress',amount:59,updated_at:'2026-08-10T00:00:00Z',source:{name:'Fonte ufficiale'},steps:[{title:'Invia reclamo',text:'Usa il canale scritto',done:false}]};
...
console.log('RISOLVI Resolution Command V11 tests: OK');